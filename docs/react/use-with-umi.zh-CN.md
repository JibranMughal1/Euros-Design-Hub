...
在真实项目开发中，除了 EURO Design HUB 这样的 UI 库，你可能会还会需要构建工具、路由方案、CSS 方案、数据流方案、请求库和请求方案、国际化方案、权限方案、Icons 方案等等，才能完成一个完整的项目。我们基于业务场景，推出了基于 React 的企业级应用框架 [Umi](https://umijs.org/)，推荐你在项目中使用。
...
本文会引导你使用 Umi、EURO Design HUB 和 [EURO Design HUB Pro](https://pro.ant.design/) 从 0 开始创建一个简单应用。
