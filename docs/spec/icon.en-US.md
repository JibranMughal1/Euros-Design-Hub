...
An icon is a graphical representation of meaning. Icons can be used to express actions, state, and even to categorize data. EURO Design HUB's icons adhere to the following two principles and are designed for cross-platform consistency:
...
System icons are often used to represent commonly used operations, such as: save, edit, delete. EURO Design HUB also includes icons to represent file types and state.
...
<ImagePreview>
<img class="preview-img no-padding" src="https://gw.alipayobjects.com/zos/rmsportal/beTZeZjJBVuhMyTOhebs.png" alt="EURO Design HUB's grid and key contour lines" alt="Key Contour Lines">
</ImagePreview>
...
Consistent stroke weight is the key to maintaining the visual unity of the entire icon system. EURO Design HUB's icons have a consistent line width of 72px.
...
Icons that follow EURO Design HUB should have rounded corners and edges using a 72px radius.
...
Icons should be scaled according to the text size, according to the EURO Design HUB specification.
