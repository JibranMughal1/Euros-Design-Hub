...
<ImagePreview>
  <img class="preview-img" alt="Example of the different vertical distance" description="In EURO Design HUB, the three different formats are 8px (small spacing), 16px (middle spacing) and 24px (large spacing)." src="https://gw.alipayobjects.com/zos/rmsportal/goazWUHPXsGEDFIGsNlm.png">
</ImagePreview>
...
> Note: in EURO Design HUB, y = 8 + 8 \* n, among which, n >= 0, y stands for the vertical spacing and 8 represents 「basic spacing」.
